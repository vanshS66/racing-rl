	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Receive Specular:false,true:true
				...
				false:RemoveDefine:ForwardBase:pragma shader_feature_local_local _SPECULARHIGHLIGHTS_OFF
				false:RemoveDefine:ForwardAdd:pragma shader_feature_local_local _SPECULARHIGHLIGHTS_OFF
				false:RemoveDefine:Deferred:pragma shader_feature_local_local _SPECULARHIGHLIGHTS_OFF			
		...
		*/
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#if defined(ASE_LIGHTING_SIMPLE)
					o.Specular = /*ase_frag_out:Spec;Float;20;-1;_Spec*/1/*end*/;
					o.Gloss = /*ase_frag_out:Gloss;Float;21;-1;_Gloss*/1/*end*/;
				#else
					#if defined(_SPECULAR_SETUP)
						o.Specular = /*ase_frag_out:Specular;Float3;3;-1;_Specular*/fixed3( 1, 1, 1 )/*end*/;
					#else
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#if defined(ASE_LIGHTING_SIMPLE)
					o.Specular = /*ase_frag_out:Spec;Float;20;-1;_Spec*/0/*end*/;
